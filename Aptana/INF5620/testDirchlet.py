...
def diffusion(dimension,d,alpha,f,rho,size,dt):
    """
...
def verification_analytical(dimension,d,size,dt):
    ...
    U = diffusion(dimension,d,alpha,f,rho,size,dt)
...
dimension = 1
d = 1
verification_analytical(dimension,d,size,dt)
